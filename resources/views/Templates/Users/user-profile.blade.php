                    ...
                    <div class="col-md-8">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-info" data-toggle="modal" data-target="#editProdileModal">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="editProdileModal" tabindex="-1" role="dialog" aria-labelledby="editProdileModal" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Profile</h5>
                                        <button type="button" class="close" id="edit_profile_close" data-dismiss="modal" aria-label="Close">
