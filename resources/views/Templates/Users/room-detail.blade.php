                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-md-4 d-flex align-items-center">
                                        ...
                                        <span><a href="https://demo.htmlcodex.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="0d64636b624d68756c607d6168236e6260">[email&#160;protected]</a></span>
                                    </div>
                                </div>
                            ...
                            <div id="tab-4" class="tab-pane fade show p-0">
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex mb-4">
                                        <img src="{{ asset('assets/Users/img/user.jpg') }}" class="img-fluid rounded"
                                            style="width: 45px; height: 45px;">
                                        <div class="ps-3">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title text-center text-primary text-uppercase">Related Hotel's</h6>
                <h1 class="mb-5">Explore More <span class="text-primary text-uppercase">Hotel</span></h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.9s">
                    <a href="{{ route('user.explore_more_hotels') }}" class="btn btn-primary py-3 px-5">Explore All Rooms</a>
                </div>
            </div>
        </div>
    </div>
