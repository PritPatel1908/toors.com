                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-light rounded-2">
                                                    <img class="p-2" src="{{ asset('assets/Admin/img/icons/brand-1.svg') }}">
                                                </div>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-light rounded-2">
                                                    <img class="p-2" src="{{ asset('assets/Admin/img/icons/brand-2.svg') }}">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-light rounded-2">
                                                    <img class="p-2" src="{{ asset('assets/Admin/img/icons/brand-3.svg') }}">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-light rounded-2">
                                                    <img class="p-2" src="{{ asset('assets/Admin/img/icons/brand-4.svg') }}">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-light rounded-2">
                                                    <img class="p-2" src="{{ asset('assets/Admin/img/icons/brand-5.svg') }}">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
